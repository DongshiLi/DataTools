...
namespace Strategy
{
   public class HistoricalLowClose
    {
        ...
        public HistoricalLowClose(List<KeyValuePair<DateTime, Quote>> stock, List<KeyValuePair<DateTime, (decimal, decimal, decimal, decimal)>> ohlc, int close, int start)
        {
        ...
        public void histlowclose()
        {
            var HISTLOWCLOSE = QH_IndicatorUtils.HISTLOWCLOSE(StockOHLCList, StartIndex);
        }
    }
}
