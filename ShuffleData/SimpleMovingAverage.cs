   ...
   public class HullMovingAverage
    {
        ...
        public HullMovingAverage(List<KeyValuePair<DateTime, Quote>> stock, List<KeyValuePair<DateTime, (decimal, decimal, decimal, decimal)>> ohlc, int close, int rolling)
        {
        ...
        public int smaTradingRule(int index, decimal OpenDiff, decimal Price, int Position, string newFileName, DateTime StopTime)
        {
            ...
            var HMA = QH_IndicatorUtils.HMA(StockOHLCList, RollingPeriodCount);
