...
namespace Strategy
{
   public class HistoricalHighHigh
    {
        ...
        public HistoricalHighHigh(List<KeyValuePair<DateTime, Quote>> stock, List<KeyValuePair<DateTime, (decimal, decimal, decimal, decimal)>> ohlc, int close, int start)
        {
        ...
        public void histhighhigh()
        {
            var HISTHIGHHIGH = QH_IndicatorUtils.HISTHIGHHIGH(StockOHLCList, StartIndex);
        }
    }
}
