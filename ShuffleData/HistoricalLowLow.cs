   ...
   public class HistoricalLowLow
    {
        ...
        public HistoricalLowLow(List<KeyValuePair<DateTime, Quote>> stock, List<KeyValuePair<DateTime, (decimal, decimal, decimal, decimal)>> ohlc, int close, int start)
        {
        ...
        public void histlowlow()
        {
            var HISTLOWLOW = QH_IndicatorUtils.HISTLOWLOW(StockOHLCList, StartIndex);
        }
    }
}
