   ...
   public class HighClose
    {
        ...
        public HighClose(List<KeyValuePair<DateTime, Quote>> stock, List<KeyValuePair<DateTime, (decimal, decimal, decimal, decimal)>> ohlc, int close, int rolling)
        {
        ...
        public void highclose()
        {
            var HIGHCLOSE = QH_IndicatorUtils.HIGHCLOSE(StockOHLCList, RollingPeriodCount);
        }
    }
}
